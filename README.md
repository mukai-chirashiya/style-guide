...
### ローカルルールも尊重する
- コードを書く前にすでに書かれているコードを眺めて、使われている命名規則やコーディングスタイルを理解するように務める。もし一貫したローカルルールの存在が認められる場合は、本スタイルガイドよりもローカルルールを優先してコードを書く方が良い。
...
```
#### ▽例【OK】略語でもすぐに意味がわかるものはOK
```html
<button class="ham-button" id="ham-button"></button>
```
#### ▽例【NG】hbが何を意味するのかわかりづらい
```html
