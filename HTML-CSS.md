...
メンテナンスがしにくいCSSになってしまう。<br>
また、ネストが深いCSSはCSSの読み込み速度を低下させることが知られている。<br>
以上の理由から、セレクタのネストが深くなりすぎないように注意し、ネストをする場合は以下のように孫セレクタまでに留めることを推奨する。
```css
親 > 子　> 孫
```
